...
<div class="container">
    ...
    <div class="contentContainer">
    	<div class="pageTitleContainer">
            ...
            <div class="pageSubtitle"><span class="pageSubtitleLine"></span>CONTACT<span class="pageSubtitleLine"></span></div>
        </div>
        <div class="contactContainer">
        	<div class="contactDiv" style="background-image: url(__PUBLIC__/config/img/<?php echo ($result['contactLogo']['value']); ?>)">
            	<div class="contactText"><?php echo ($result['contactText']['value']); ?><span></span><a href="<?php echo ($result['contactMail']['value']); ?>" class="mailClass" style="color:#b42b34"><?php echo ($result['contactMail']['value']); ?></a></div>
                <div class="contactMail">
                    <span style=" font-weight: 900;">电话：</span><a href="tel:<?php echo ($result['contactMail']['value']); ?>" class="mailClass"><?php echo ($result['contactTel']['value']); ?></a>
                </div>
            </div>
        </div>
    </div>
