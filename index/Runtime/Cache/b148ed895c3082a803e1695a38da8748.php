	...
	<div class="container">
        ...
        <div class="contentContainer">
        	<div class="pageTitleContainer">
            	<div class="pageTitle">磐恩动态</div>
                <div class="pageSubtitle"><span class="pageSubtitleLine"></span>NEWS<span class="pageSubtitleLine"></span></div>
            </div>
            <div class="newsListContainer">
            	<?php if(is_array($result)): foreach($result as $key=>$item): ?><!--star-->
	            	<a href="__APP__/News/info?id=<?php echo ($item['id']); ?>" class="newsList">
	                	<div class="newsListImgContainer">
	                    	<img src="__ROOT__/Uploads/images/news/<?php echo ($item['logo']); ?>" />
	                    </div>
	                    <div class="newsListTextContainer">
	                    	<div class="newsListTextTitle"><?php echo ($item['title']); ?></div>
	                        <div class="newsListTextSubtitle"><?php echo ($item['from_str']); ?></div>
	                        <div class="newsListTextContent"><?php echo (ssubstr($item['desc'],100,0)); ?></div>
	                    </div>
	                    <div class="newListTimeContainer">
	                    	<div class="newListTimeTimeLine"></div>
	                    	<div class="newListTimeMonth"><?php echo (date("m",$item['created_at'])); ?></div>
	                        <div class="newListTimeYear"><?php echo (date("Y",$item['created_at'])); ?></div>
	                    </div>
