    ...
    <div class="contentContainer">
        ...
        <div class="contactContainer">
        	<div class="contactDiv" style="background-image: url(__PUBLIC__/config/img/<?php echo ($result['contactLogo']['value']); ?>)">
            	<div class="contactText"><?php echo ($result['contactText']['value']); ?></div>
                <div class="contactMail">
                	<span>邮箱：</span><a href="<?php echo ($result['contactMail']['value']); ?>" class="mailClass"><?php echo ($result['contactMail']['value']); ?></a>
                </div>
            </div>
        </div>
    </div>
