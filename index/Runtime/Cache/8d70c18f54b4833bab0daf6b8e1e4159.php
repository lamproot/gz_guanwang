	...
	<div class="container">
        ...
        <div class="breadContainer">
        	<div class="breadContent">
            	<a href="__APP__/Segments/index" class="breadA">业务板块</a>
                <span class="breadSeparate">></span>
                <a class="breadA select"><?php echo ($result['name']); ?></a>
        	</div>
        </div>
        <div class="contentContainer">
        	<div class="pageTitleContainer">
            	<div class="pageTitle"><?php echo ($result['name']); ?></div>
                <div class="pageSubtitle"><span class="pageSubtitleLine"></span><?php echo ($result['ename']); ?><span class="pageSubtitleLine"></span></div>
            </div>
            ...
            <!-- <div class="teamIntroContainer">
                <div class="teamIntroContent">
                	<div class="richManageContainer">
                        <img src="img/yewu-m-map.jpg">
                    </div>
                </div>
            </div> -->
        </div>
