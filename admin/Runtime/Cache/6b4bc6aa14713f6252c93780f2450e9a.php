                ...
                <div class="ibox-content">
					<form class="form-horizontal m-t" id="signupForm" method="post" action="__ACTION__" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <select name="type" class="form-control">
                                    <option value="0" <?php if($result['type'] == 0): ?>selected="selected"<?php endif; ?>>公司动态</option>
                                    <option value="1" <?php if($result['type'] == 1): ?>selected="selected"<?php endif; ?>>投研视点</option>
                                     <option value="2" <?php if($result['type'] == 2): ?>selected="selected"<?php endif; ?>>业内资讯</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="from_str" class="form-control" value="<?php echo ($result["from_str"]); ?>">
                            </div>
                        </div>
						...
						<div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <?php if($result['logo'] != ''): ?><img src="__ROOT__/Uploads/images/news/<?php echo ($result["logo"]); ?>" style="height:100px; width:100px;margin-bottom:10px;" class="logourl"/><?php endif; ?>
                                <input id="file" name="logo" class="form-control file" type="file">
                                <input name="logoname" class="form-control logoname" type="hidden" value="<?php echo ($result['logo']); ?>">
                            </div>
                        </div>
                    ...
                    <form class="form-horizontal m-t" id="uploadForm" method="post" action="__ACTION__" enctype="multipart/form-data">
