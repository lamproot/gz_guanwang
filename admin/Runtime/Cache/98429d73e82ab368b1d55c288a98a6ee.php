                ...
                <div class="ibox-content table-responsive">
                    <div class="row">
                        <div class="col-sm-12 m-b-xs">
							<p>
                                <a type="button" class="btn btn-w-m btn-danger" href="__APP__/TeamClass/add">新增</a>
                            </p>
                        </div>
                    </div>
                        ...
                        <table class="table table-hover no-margins table-bordered table-striped">
                            ...
                            <tbody>
                                <?php if(is_array($result['result'])): foreach($result['result'] as $key=>$new): ?><tr>
                                        ...
                                        <td>
    										<a href="__APP__/TeamClass/edit/id/<?php echo ($new["id"]); ?>">编辑</a>
    										<a href="__APP__/TeamClass/delete/id/<?php echo ($new["id"]); ?>" onclick="return confirm('确认删除吗？')">删除</a>
                                        </td>
