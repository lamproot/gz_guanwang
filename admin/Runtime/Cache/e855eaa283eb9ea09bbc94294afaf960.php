                ...
                <div class="ibox-content table-responsive">
                    <div class="row">
                        <div class="col-sm-12 m-b-xs">
							<p>
                                <a type="button" class="btn btn-w-m btn-danger" href="__APP__/Teams/add">新增</a>
                            </p>
                        </div>
                    </div>
                        ...
                        <table class="table table-hover no-margins table-bordered table-striped">
                            ...
                            <tbody>
                                <?php if(is_array($result['result'])): foreach($result['result'] as $key=>$new): ?><tr>
                                        ...
                                        <td><?php echo ($new["tname"]); ?></td>
                                        <td>
                                            <?php if($new['logo'] != ''): ?><img src="<?php echo ($new["logo"]); ?>" alt="" style="width:100px;height:100px;"><?php endif; ?>
                                        </td>
                                        <td><?php echo ($new["title"]); ?></td>
                                        <td>
    										<a href="__APP__/Teams/edit/id/<?php echo ($new["id"]); ?>">编辑</a>
    										<a href="__APP__/Teams/delete/id/<?php echo ($new["id"]); ?>" onclick="return confirm('确认删除吗？')">删除</a>
                                           <!--  <?php if($new['status'] == 0): ?><a href="__APP__/Teams/status/id/<?php echo ($new["id"]); ?>/type/0">禁用</a>
                                            <?php elseif($new['status'] == 1): ?>
                                                <a href="__APP__/Teams/status/id/<?php echo ($new["id"]); ?>/type/1">启用</a><?php endif; ?> -->
                                        </td>
