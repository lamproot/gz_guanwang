	...
	<div class="container">
        ...
        <div class="breadContainer">
        	<div class="breadContent">
            	<a href="__APP__/News" class="breadA">
                    <?php if($result['type'] == 0): ?>公司动态
                    <?php elseif($result['type'] == 1): ?>
                    投研视点
                    <?php elseif($result['type'] == 2): ?>
                    业内资讯<?php endif; ?>列表</a>
                <span class="breadSeparate">></span>
                <a class="breadA select"><?php if($result['type'] == 0): ?>公司动态
                    <?php elseif($result['type'] == 1): ?>
                    投研视点
                    <?php elseif($result['type'] == 2): ?>
                    业内资讯<?php endif; ?></a>
        ...
        <div class="contentContainer">
        	<div class="newsInfoContainer">
            	<div class="newsInfoTitle"><?php echo ($result['title']); ?></div>
                <div class="newsInfoTime"></div>
                <div class="newsInfoTextContainer">
