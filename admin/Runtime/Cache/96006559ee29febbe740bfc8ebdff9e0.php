                        ...
                        <table class="table table-hover no-margins table-bordered table-striped">
                            ...
                            <tbody>
                                <?php if(is_array($result['result'])): foreach($result['result'] as $key=>$new): ?><tr>
                                        ...
                                        <td>
                                            <?php if($new['type'] == 0): ?>公司动态
                                            <?php elseif($new['type'] == 1): ?>
                                                投研视点
                                            <?php else: ?>
                                                业内资讯<?php endif; ?>
                                        </td>
                                        ...
                                        <td>
                                           ...
                                           <!--  <?php if($new['status'] == 0): ?><a href="__APP__/News/status/id/<?php echo ($new["id"]); ?>/type/0">禁用</a>
                                            <?php elseif($new['status'] == 1): ?>
                                                <a href="__APP__/News/status/id/<?php echo ($new["id"]); ?>/type/1">启用</a><?php endif; ?> -->
                                        </td>
